...
* @param {Array} buffArray - array of buffers
* @returns {Buffer} - New buffer
*/
function buffArrayToBuffer(buffArray) { // TODO old: nodeValueToBuffer
...
*/
function bufferToBuffArray(buff) { // TODO old: bufferToNodeValue
  const arrayBuff = [];
