...
//       this.room.on('message', message => this.recv(message, this.recvWallet));
...
//   }
//
//   async recvWallet(message) {
//     status(`wallet got ${message}`, true);
//
//     let [op, args] = message.split('|');
//     if (op === 'call') {
//       const ksignaddr = '0xee602447b5a75cf4f25367f5d199b860844d10c4';
//       let ksignpvk = ethutil.toBuffer('0x8A85AAA2A8CE0D24F66D3EAA7F9F501F34992BACA0FF942A8EDF7ECE6B91F713');
//
