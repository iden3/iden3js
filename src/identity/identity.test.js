...
describe('[identity]', () => {
  ...
  it('Generate identity', () => {
    ...
    expect(identity.id).to.be.equal('117h4RGBgK2yUZDVXiW3Q3y8vTCfttbYAtK7jbsz5a');
  ...
  it('Load identity', () => {
    const identity = iden3.Identity.load(db1, '117h4RGBgK2yUZDVXiW3Q3y8vTCfttbYAtK7jbsz5a');
